...
function HeroSection() {
  return (
    <div className="home container px-5 lg:px-0 mx-auto py-10 flex max-h-[90vh] relative overflow-hidden">
      {/* others  */}
      <img src={HeroCircle} alt="circle" className="absolute bottom-0 z-0" />
