...
const StepSeven = ({ nextStep, prevStep, setSelection }) => {
  ...
  const handleCheckboxChange = (e) => {
    ...
    if (name === 'checkbox2' && !checked) setCounter1(0);
    if (name === 'checkbox3' && !checked) setCounter2(0);
  };
  ...
  const handleNext = () => {
    ...
    const selected = {
      ...
      counterValues: {
        counter1: selectedCheckboxes.checkbox2 ? counter1 : 0,
        counter2: selectedCheckboxes.checkbox3 ? counter2 : 0,
      },
    };
