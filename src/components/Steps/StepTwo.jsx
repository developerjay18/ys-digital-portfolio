...
const StepTwo = ({ nextStep, prevStep, setSelection }) => {
  ...
  return (
    <div className="lg:w-[70%] w-[95%] mx-auto lg:min-h-[77vh] flex flex-col justify-center">
      <div className="join-shadow font-poppins p-6">
        ...
        {/* options  */}
        <div className="videos mt-8 lg:mx-16 flex flex-col lg:flex-row justify-center items-center gap-x-8 gap-y-6">
      ...
      <div className="bg-themeBlue flex justify-between text-white py-3 px-5 lg:px-16">
        <div className="flex items-center">
          <button
            className="text-xl flex items-center justify-center lg:ml-auto gap-x-2"
            onClick={prevStep}
          >
            Previous{' '}
            <img
